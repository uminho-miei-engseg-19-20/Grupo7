...
class Blockchain{
    ...
    createGenesisBlock(){
        ...
        return new Block(0, timestamp, "Bloco Inicial da koreCoin", "0");
    }
...
koreCoin.addBlock(new Block (3, "02/01/2018", {amount: 40, Block2: 25}));
koreCoin.addBlock(new Block (4, "01/11/2019", {amount: 150, Block1: 10}));
koreCoin.addBlock(new Block (5, "05/01/2020", {amount: 46}));
...
console.log(JSON.stringify(koreCoin, null, 6));
